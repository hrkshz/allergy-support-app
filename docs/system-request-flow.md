...
この資料は、[`portfolio-system-overview.md`](./portfolio-system-overview.md) を読んでも
まだ見えにくい、
...
主要なコンポーネントの役割は [`portfolio-system-overview.md`](./portfolio-system-overview.md) にまとめています。  
この資料では、順番に何が起きるかだけに集中します。
